...
List<Dormitory> dormitoryList = (List)request.getAttribute("dormitoryList");
                                ...
                                <table id="footable-res2" class="demo" data-filter="#filter" data-filter-text-only="true" data-page-size="10">
                                    ...
                                    %>
                                        <tr>
                                            ...
                                            <td><%=dormitory.getName() %>
                                            <td><%=dormitory.getPhone() %>
                                            <td><%=dormitory.getAddress() %></td>
                                            	<td><a href="<%=path%>/dormitory.do?method=del&id=<%=dormitory.getId()%>">删除</a>
                                            		&nbsp;&nbsp;<a href="<%=path%>/dormitory.do?method=goCheckDormitory&id=<%=dormitory.getId()%>">查看</a>
                                            	</td>
                                            <td data-value="1">
