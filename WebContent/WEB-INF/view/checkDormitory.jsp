<%@page import="com.mvc.entity.Admin"%>
<%@ page language="java" import="java.util.*" pageEncoding="UTF-8"%>
<%@ include file="/include/head.jsp"%>
<%
String path = request.getContextPath();
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
List<Map> studentList = (List)request.getAttribute("studentList");
                ...
                <ul style="margin-right:0;" class="nav navbar-nav navbar-right">
                    <li>
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            Hi, <%=admin.getName() %> <b class="caret"></b>
                        </a>
        ...
        <div class="container-fluid paper-wrap bevel tlbr">
                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="tittle-middle-header">
                            ...
                            <div class="alert">
                                ...
                                你好,&nbsp;
                                <strong><%=admin.getName() %>!</strong>&nbsp;&nbsp;<!-- 你上次登陆时间是： -->
                            </div>
            ...
            <ul id="breadcrumb">
                ...
                <li><i class="fa fa-lg fa-angle-right"></i>
    	            ...
    	            <li><a href="＃" title="Sample page 1">查看宿舍人员</a>
                </li>
                                ...
                                <table id="footable-res2" class="demo" data-filter="#filter" data-filter-text-only="true" data-page-size="10">
                                    ...
                                    %>
                                        <tr>
                                            <td><%=map.get("id") %></td>
                                            <td><%=map.get("name") %>
                                            <td><%=map.get("authority") %>
                                            	<td><a href="<%=path%>/admin.do?method=goAdminTable&id=<%=map.get("id") %>">删除</a>
                                            	</td>
                                        </tr>
                                      <%} %>
                                        <!-- <tr>
                                    ...
                                    <form action="<%=path %>/dormitory.do?method=addStd" id="contact-form" class="form-horizontal" method="post">
                                        <fieldset>
                                            <div class="control-group">
                                				...
                                				<div class="control-group">
                                            		<label class="control-label" for="authority">职位</label>
			                                    <div class="controls">
			                                            <select id="authority" name="authority" class="form-control">
			                                                <option value="舍员" selected="selected">舍员</option>
			                                                <option value="舍长">舍长</option>
			                                            </select>
			                                    </div>
                                				</div>
